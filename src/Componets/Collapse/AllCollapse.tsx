...
import { AllCollapseProps } from '../../interfaces/mail.interface';
...
const AllCollapse: React.FC<AllCollapseProps> = ({
	countMessage,
	countRead,
	countDelete,
	showFolder,
	...
	return (
		<div>
			<Accordion square expanded={expanded === 'pnTerceros'} onChange={handleChange('pnTerceros')}>
			...
			<Accordion
				...
				<AccordionDetails>
					<MailAccount
						countMsg={countMessage}
						countRead={countRead}
						countDelete={countDelete}
						showFolderMessage={showFolder}
					/>
				</AccordionDetails>
			</Accordion>
			<Accordion
