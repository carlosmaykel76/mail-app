...
import { searchContactProps } from '../../interfaces/mail.interface';
...
const SearchContacts: React.FC<searchContactProps> = ({ openContacts }) => {
			...
			<WindowActionsBar layout='end'>
				<Grid container spacing={1}>
					...
					<Grid item xs style={{ display: 'flex', justifyContent: 'flex-end' }}>
						<button type='button' className='k-button' onClick={closeModal}>
							Cerrar
						</button>
					</Grid>
				</Grid>
